...
export default function Login({ onLoginSuccess, onNavigateToCadastro, onVoltarCardapio }) {
  ...
  const handleLogin = () => {
    ...
    // Passa o e-mail ou nome fictício para simular a autenticação
    onLoginSuccess({ nome: email.split('@')[0] });
  };
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Faça login para concluir o envio do seu pedido</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.button} onPress={handleLogin} activeOpacity={0.8}>
            <Text style={styles.buttonText}>Entrar e Concluir Pedido</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#DC2626', borderRadius: 10, paddingVertical: 16, alignItems: 'center', marginTop: 12, elevation: 3 },
